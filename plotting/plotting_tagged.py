...
cen_stars = calc_3D_cm(selected_parts,selected_masses)
...
sns.kdeplot(data = data_all_tagged, x='x',y='y',weights='masses',fill=True)
sns.kdeplot(data = data_only_acc_tagged, x='x',y='y',weights='masses',fill=True)


#plt.scatter(cen_stars[0],cen_stars[1],label='Stellar Center')
